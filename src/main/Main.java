...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length > 0) {
			...
			if (file.exists()) {
				...
				DeepBoltzmannMachineTrainer trainer = new DeepBoltzmannMachineTrainer(dbm, new AdaptiveLearningFactor(0.001, 0.8, 1.5), 100, Double.MIN_VALUE, 0.9, 1, 0);
				trainer.train(training);
			}
		}
	}
	...
	private static void testRestrictedBoltzmannMachine() {
		...
		RestrictedBoltzmannMachineTrainer t = new RestrictedBoltzmannMachineTrainer(rbm, new AdaptiveLearningFactor(), 500, Double.MIN_VALUE, 0.9, 1, 0);
	...
	private static void testGaussian() {
		...
		RestrictedBoltzmannMachineTrainer t = new RestrictedBoltzmannMachineTrainer(rbm, new AdaptiveLearningFactor(0.001, 1, 1), 500, Double.MIN_VALUE, 0.9,1,0);
		t.addTrainingStepCompletedListener(new TrainingStepCompletedListener() {
	...
	private static void testDeepBoltzmannMachine() {
		...
		DeepBoltzmannMachineTrainer trainer = new DeepBoltzmannMachineTrainer(dbm, new AdaptiveLearningFactor(0.01, 1, 1), 100, Double.MIN_VALUE, 0.9,1,0);
		trainer.train(training);
		try {
